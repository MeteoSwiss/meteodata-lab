...
&Process
  ...
  tstart=0, tstop=0, tincr=1
/
&Process in_field="{{ field }}", levmin=1, levmax=81 /
&Process tmp1_field="HEIGHT", tag="hhl" /
&Process tmp1_field="HEIGHT", tag="hhl_bottom", levlist={{ kbottom }} /
&Process tmp1_field="HEIGHT", tag="hhl_top", levlist={{ ktop }} /
&Process tmp1_field="{{ field }}", voper="{{ minmax }}_z2z,hhl_bottom,hhl_top", voper_use_tag="hhl" /
