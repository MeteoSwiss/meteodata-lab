...
&Process
  ...
  tstart=0, tstop=0, tincr=1
/
&Process in_field="{{ field }}", levmin=1, levmax=80 /
&Process tmp1_field="HEIGHT", tag="hfl" /
&Process tmp1_field="HEIGHT", tag="hfl_bottom", levlist={{ kbottom }} /
&Process tmp1_field="HEIGHT", tag="hfl_top", levlist={{ ktop }} /
&Process tmp1_field="{{ field }}", voper="{{ minmax }}_z2z,hfl_bottom,hfl_top", voper_use_tag="hfl" /
