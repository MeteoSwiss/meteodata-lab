...
/
&Process in_field="HEIGHT", tag="hhl", level_class="k_half", levmin=1, levmax=81 /
&Process in_field="HEIGHT", tag="hfl_bottom", level_class="k_full", levlist={{ kbottom }} /
&Process in_field="HEIGHT", tag="hfl_top", level_class="k_full", levlist={{ ktop }} /
...
&Process
  ...
  tstart=0, tstop=0, tincr=1
/
# norm_integ also works in this way
&Process in_field="{{ field }}", levmin=1, levmax={{ kmax }}, voper="{{ operator }}_{{ mode }},hfl_bottom,hfl_top" /
&Process out_field="{{ field }}" /
