...
def test_intpl_k2theta_lowfold():
    ...
    T = interpolate_k2theta(ds["T"], "low_fold", THETA, [280.,290.,310.,315.,320.,325.,330.,335.], "K", HFL)
    ...
    subprocess.run([executable, tmpdir + "/test_intpl_k2theta_lowfold.nl "], check=True)

    fs_ds = xr.open_dataset("00_intpl_k2theta_lowfold.nc")
